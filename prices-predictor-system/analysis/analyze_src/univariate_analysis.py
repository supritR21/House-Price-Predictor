...
class UnivariateAnalysisStrategy(ABC):
    ...
    def analyze(self, df: pd.DataFrame, feature: str):
        ...
        feature (str): The name of the feature/column to be anlayzed.
...
# ------------------------------------------
# This strategy analyzes categorical features by plotting their frequency distrivution.
...
class UnivariateAnalyzer:
    ...
    def execute_analysis(self, df: pd.DataFrame, feature: str):
        ...
        Parameters:
        df (pd.DatFrame): The dataframe containing the data.
