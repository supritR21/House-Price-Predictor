...
# Absstract Base Class for Outlier Detection Strategy
...
if __name__ == "__main__":
    ...
    ## Initialize the OutlierDetector with Z-Score based Outlier Detection Strategy
    # outlier_detector = OutlierDetector(ZScoreOutlierDetection(threshold=3))

    ## Detect and handle outliers
    # outliers = outlier_detection.detect_outliers(df_numeric)
    # df_cleaned = outlier_detector.handle_outliers(df_numeric,methood="remove")
