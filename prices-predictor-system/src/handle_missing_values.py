...
class DropMissingValuesStrategy(MissingValueHandlingStrategy):
    def __init__(self, axis=0, thresh=None):
        ...
        thresh (int): The threshold for non_NA values. Rows/Columns with less than thresh non-NA values are dropped.
        """
        self.axis = axis
        self.thresh = thresh
...
class FillMissingValuesStrategy(MissingValueHandlingStrategy):
    def __init__(self, method="mean", fill_value=None):
        ...
        Parameters:
        mehtod (str): The method to fill missing values ("mean", "median", "mode", or "constant").
...
if __name__ == "__main__":
    # Example dataframe
    # df = pd.read_csv("../extrcted-data/your_data_file.csv")
