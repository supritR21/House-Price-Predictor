...
class FeatureEngineeringStrategy(ABC):
    ...
    def apply_transformation(self, df:pd.DataFrame) -> pd.DataFrame:
        ...
        Returns:
        pd.DataFrame: A dataframe with the appied transformations.
        """
        pass
...
class LogTransformation(FeatureEngineeringStrategy):
    ...
    def apply_transformation(self, df:pd.DataFrame) -> pd.DataFrame:
        ...
        Parameters:
        df (pd.DataFrame): The dataframe containing feaatures to transform.
...
# --------------------------------------
# This strategy applies Min-Max scaling to features, scaling them to a specific range, typically [0, 1].
...
class FeatureEngineer:
    ...
    def set_strategy(self, strategy: FeatureEngineeringStrategy):
        """
        Sets a new strategy for FeatureEngineer.
        
        Parameters:
        strategy (FeatureEngineeeringStrategy): The new strategy to be used for feature engineering.
        """
